...
# Generated by Tools/ssl/make_ssl_data.py against OpenSSL 4.0.0 (from CPython gh-148601)
Source5:	python-3.14-_ssl_data_40.h
...
# OpenSSL 4.0: drop removed SSLv3/TLSv1*_method symbols (gh-146207 / gh-148600)
python-3.14-openssl4.patch
...
# OpenSSL 4.0 error-code table (not in 3.14.6 tarball; from CPython main / gh-148601)
cp -p %{SOURCE5} Modules/_ssl_data_40.h
